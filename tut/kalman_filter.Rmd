...
scala> val data = Dlm.simulateRegular(0, mod, p).
     ...
     |   take(1000).
     |   toArray
data: Array[(dlm.model.Data, breeze.linalg.DenseVector[Double])] = Array((Data(1.0,Some(DenseVector(1.6367485364146204))),DenseVector(-0.024291697896929646)), (Data(2.0,Some(DenseVector(1.3865015526187339))),DenseVector(-1.3452305807085514)), (Data(3.0,Some(DenseVector(-5.743356634945988))),DenseVector(-1.8883672178436997)), (Data(4.0,Some(DenseVector(-1.4685894022959676))),DenseVector(-2.1078589486747252)), (Data(5.0,Some(DenseVector(0.4010666523257347))),DenseVector(-1.9407654976724549)), (Data(6.0,Some(DenseVector(-2.0946918451328513))),DenseVector(-1.5570332264022189)), (Data(7.0,Some(DenseVector(-0.2725135415920227))),DenseVector(-1.271540794682073)), (Data(8.0,Some(DenseVector(2.1532988685061367))),DenseVector(-1.2417425429878266)), (Data(9.0,Some(DenseVector(-0.5670315172334155))...
```
...
filtered: Array[dlm.model.KalmanFilter.State] = Array(State(0.0,DenseVector(0.0),1.0  ,DenseVector(0.0),1.0  ,None,None,0.0), State(1.0,DenseVector(0.6546994145658482),1.2000000000000002  ,DenseVector(0.0),2.0  ,Some(DenseVector(0.0)),Some(5.0  ),-1.991552066567263), State(2.0,DenseVector(0.9643080114343767),1.2692307692307692  ,DenseVector(0.6546994145658482),2.2  ,Some(DenseVector(0.6546994145658482)),Some(5.2  ),-3.786313601917432), State(3.0,DenseVector(-1.9243942815323496),1.2919708029197077  ,DenseVector(0.9643080114343767),2.269230769230769  ,Some(DenseVector(0.9643080114343767)),Some(5.269230769230769  ),-9.805580789667129), State(4.0,DenseVector(-1.7269836165941097),1.2993103448275862  ,DenseVector(-1.9243942815323496),2.2919708029197077  ,Some(DenseVector(-1.9243942815323496))...
```
