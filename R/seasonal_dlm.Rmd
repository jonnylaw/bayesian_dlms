...
sims = read_csv("../core/data/seasonal_dlm.csv")
...
```{r filtered-seasonal}
filtered = read_csv("../core/data/seasonal_filtered.csv")
...
```{r smoothed-seasonal}
smoothed = read_csv("../core/data/seasonal_smoothed.csv")
...
iters = read_csv("../core/data/seasonal_dlm_gibbs.csv")
...
forecast = read_csv("../core/data/seasonal_model_forecast.csv")
