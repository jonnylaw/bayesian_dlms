...
$$F = \begin{pmatrix}1 \\ 0 \\ 1 \\ \vdots \\ 1 \\ 0 \end{pmatrix}.$$
...
Then we can simlulate from the model by supplying parameters and use the provided simulate function:
...
```scala
val filtered = KalmanFilter.kalmanFilter(mod, sims, p)
```
