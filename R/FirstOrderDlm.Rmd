...
Inverse gamma priors on the system and observation variances, $p(V) = \textrm{InverseGamma}(1.0, 10.0)$, meaning the prior mean of the observation variance is $\mathbb{E}(V) = 10 / 11$.
