...
```{r plot_student_t}
sims = read_csv("../core/data/student_t_dglm.csv")
...
chain = read_csv("../core/data/student_t_dglm_pmmh.csv")
...
```{r pg-ar, eval=FALSE}
chain = read_csv("../core/data/student_t_dglm_gibbs_ancestor.csv")
...
```{r density_student_t}
chain = read_csv("../core/data/student_t_dglm_gibbs.csv")
